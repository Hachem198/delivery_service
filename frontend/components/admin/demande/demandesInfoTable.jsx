...
export default function DemandesInfoTable() {
          ...
          >
            ...
            >
              ...
              <p className="text-gray-800 mb-2">
                <strong>Service:</strong> {selectedClient.email}
              </p>
              <p className="text-gray-800 mb-4">
                <strong>Type de produit:</strong> {selectedClient.quantite}
              </p>
              <p className="text-gray-800 mb-4">
                <strong>Client :</strong> {selectedClient.quantite}
              </p>
              <p className="text-gray-800 mb-4">
                <strong>Adresse de collecte :</strong> {selectedClient.quantite}
              </p>
              <p className="text-gray-800 mb-4">
                <strong>Destination :</strong> {selectedClient.quantite}
              </p>
              <p className="text-gray-800 mb-4">
                <strong>Etat de colis :</strong> {selectedClient.quantite}
              </p>
